	...
	render() {
		<footer>
					...
					<div class='col col-lg-5'>
						<div class='footer-text'>
							...
							<p>
								...
								use this layout, but it's a good example of what you can do with
								what's provided. If you wanted to included more columns for
								links and remove this text block, you can.
							</p>
						</div>
					</div>
			...
			<p class='copyright align-center'>
				Made with 🌭 by Kyle Logue. Licensed under the MIT License.
			</p>
		</footer>;
	}
}
