        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < this.contentChanges.length; i++) {
                ...
                if (contentChange.range.start.line < originalLeftBoundary.line) {
                    ...
                    originalLeftBoundary = originalLeftBoundary.with(originalLeftBoundary.line + resultLines - linesAffected);
                    continue;
                }
                if (contentChange.range.start.line === originalLeftBoundary.line) {
            ...
            if (newStart && newEnd) {
                ...
                vimState.cursorStopPosition = position_1.Position.FromVSCodePosition(newEnd)
                    .advancePositionByText(last.textDiff.text)
                    .add(last.positionDiff);
            }
    ...
    execCount(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const { start, stop } of cursorsToIterateOver) {
                ...
                resultingCursors.push(new range_1.Range(vimState.cursorStartPosition, vimState.cursorStopPosition));
                for (const transformation of vimState.recordedState.transformations) {
                    if (transformations_1.isTextTransformation(transformation) && transformation.cursorIndex === undefined) {
...
let DisableExtension = class DisableExtension extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            yield vimState.setCurrentMode(mode_1.ModeName.Disabled);
            return vimState;
        });
    }
};
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            if (vimState.currentMode === mode_1.ModeName.Normal && !vimState.isMultiCursor) {
                ...
                yield vscode.commands.executeCommand('closeMarkersNavigation');
                return vimState;
            }
...
let CommandMoveHalfPageDown = class CommandMoveHalfPageDown extends CommandEditorScroll {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let newPosition;
            if (smoothScrolling) {
                newPosition = new position_1.Position(editor.selection.active.line, editor.selection.active.character);
            }
            else {
                const newFirstLine = editor.visibleRanges[0].start.line;
                const newPositionLine = newFirstLine + lineOffset;
                const maxLineValue = textEditor_1.TextEditor.getLineCount() - 1;
                if (newPositionLine > maxLineValue) {
                    newPosition = new position_1.Position(0, 0).getDocumentEnd();
                }
                else {
                    const newPositionColumn = Math.min(startColumn, textEditor_1.TextEditor.getLineMaxColumn(newPositionLine));
                    newPosition = new position_1.Position(newPositionLine, newPositionColumn);
                }
            }
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (smoothScrolling) {
                ...
                newPosition = new position_1.Position(newFirstLine + lineOffset, startColumn);
            }
            vimState.cursorStopPosition = newPosition;
            return vimState;
        });
...
let CommandReplaceAtCursorFromNormalMode = class CommandReplaceAtCursorFromNormalMode extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            let timesToRepeat = vimState.recordedState.count || 1;
            yield vimState.setCurrentMode(mode_1.ModeName.Replace);
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (key === '<BS>' || key === '<shift+BS>' || key === '<C-h>') {
                ...
                yield vimState.setCurrentMode(vimState.globalState.searchState.previousMode);
...
let CommandOverrideCopy = class CommandOverrideCopy extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield clipboard_1.Clipboard.Copy(text);
...
let CommandCmdA = class CommandCmdA extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            vimState.cursorStopPosition = new position_1.Position(textEditor_1.TextEditor.getLineCount() - 1, vimState.desiredColumn);
            yield vimState.setCurrentMode(mode_1.ModeName.VisualLine);
            return vimState;
        });
    }
};
...
function createSearchStateAndMoveToMatch(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        vimState.globalState.searchState = new searchState_1.SearchState(args.direction, vimState.cursorStopPosition, searchString, { isRegex: isExact }, vimState.currentMode);
        vimState.cursorStopPosition = vimState.globalState.searchState.getNextSearchMatchPosition(args.searchStartCursorPosition).pos;
...
let CommandSearchForwards = class CommandSearchForwards extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            vimState.globalState.searchState = new searchState_1.SearchState(searchState_1.SearchDirection.Forward, vimState.cursorStopPosition, '', { isRegex: true }, vimState.currentMode);
            yield vimState.setCurrentMode(mode_1.ModeName.SearchInProgressMode);
...
let CommandSearchBackwards = class CommandSearchBackwards extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            vimState.globalState.searchState = new searchState_1.SearchState(searchState_1.SearchDirection.Backward, vimState.cursorStopPosition, '', { isRegex: true }, vimState.currentMode);
            yield vimState.setCurrentMode(mode_1.ModeName.SearchInProgressMode);
            // Reset search history index
            vimState.globalState.searchStateIndex = vimState.globalState.searchStatePrevious.length;
            vimState.globalState.hl = true;
...
let PutCommand = PutCommand_1 = class PutCommand extends BaseCommand {
    ...
    exec(position, vimState, after = false, adjustIndent = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (vimState.currentMode === mode_1.ModeName.VisualLine &&
                ...
                if (text.indexOf('\n') === -1) {
                    if (!position.isLineEnd()) {
                        if (register.registerMode === register_1.RegisterMode.BlockWise) {
                            if (after) {
                                diff = new position_1.PositionDiff(0, -1 * text.length);
                            }
                            else {
                                diff = new position_1.PositionDiff(0, 1);
                            }
            ...
            statusBarTextUtils_1.ReportLinesChanged(numNewlinesAfterPut, vimState);
    ...
    execCount(position, vimState) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (vimState.effectiveRegisterMode === register_1.RegisterMode.LineWise &&
                ...
                statusBarTextUtils_1.ReportLinesChanged(numNewlines, vimState);
            }
            return result;
        });
    }
    ...
    exec(position, vimState, after = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (register.registerMode === register_1.RegisterMode.LineWise) {
                ...
                yield deleteResult.setCurrentMode(oldMode);
                deleteResult = yield new PutCommand().exec(start, deleteResult, true);
                yield deleteResult.setCurrentMode(resultMode);
...
let CommandShowCommandLine = class CommandShowCommandLine extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield vimState.setCurrentMode(mode_1.ModeName.CommandlineInProgress);
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (newPositions !== undefined) {
                vimState.cursors = newPositions.map(x => new range_1.Range(x, x));
            }
            vimState.alteredHistory = true;
            statusBarTextUtils_1.ReportClear(vimState);
            return vimState;
        });
    }
};
...
let CommandDeleteToLineEnd = class CommandDeleteToLineEnd extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new operator.DeleteOperator(this.multicursorIndex).run(vimState, position, position.getLineEnd().getLeft());
        });
    }
};
...
let CommandVisualMode = class CommandVisualMode extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            yield vimState.setCurrentMode(mode_1.ModeName.Visual);
            return vimState;
        });
    }
};
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (vimState.lastVisualSelectionEnd !== undefined &&
                ...
                if (vimState.lastVisualSelectionEnd.line <= textEditor_1.TextEditor.getLineCount() - 1) {
                    yield vimState.setCurrentMode(vimState.lastVisualMode);
...
function selectLastSearchWord(vimState, direction) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const newSearchState = new searchState_1.SearchState(direction, vimState.cursorStopPosition, searchState.searchString, { isRegex: true }, vimState.currentMode);
        let result = {
        ...
        vimState.cursorStartPosition =
            vimState.currentMode === mode_1.ModeName.Normal ? result.start : vimState.cursorStopPosition;
        vimState.cursorStopPosition = result.end.getLeftThroughLineBreaks(); // end is exclusive
        // Move the cursor, this is a bit hacky...
        vscode.window.activeTextEditor.selection = new vscode.Selection(vimState.cursorStartPosition, vimState.cursorStopPosition);
        yield vimState.setCurrentMode(mode_1.ModeName.Visual);
        return vimState;
    });
}
...
let CommandVisualBlockMode = class CommandVisualBlockMode extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            yield vimState.setCurrentMode(mode_1.ModeName.VisualBlock);
            return vimState;
        });
    }
};
...
let CommandGoToDefinition = class CommandGoToDefinition extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield util_1.waitForCursorSync(1000);
...
let CommandInsertNewLineAbove = class CommandInsertNewLineAbove extends BaseCommand {
    ...
    execCount(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            vimState.cursors = yield util_1.getCursorsAfterSync();
            for (let i = 0; i < count; i++) {
                const newPos = new position_1.Position(vimState.cursors[0].start.line + i, vimState.cursors[0].start.character);
                vimState.cursors.push(new range_1.Range(newPos, newPos));
            }
    ...
    execCount(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 1; i < count; i++) {
                const newPos = new position_1.Position(vimState.cursorStartPosition.line - i, vimState.cursorStartPosition.character);
                vimState.cursors.push(new range_1.Range(newPos, newPos));
...
let CommandNavigateLastBOL = class CommandNavigateLastBOL extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const jump = new jump_1.Jump({
                editor: vimState.editor,
                fileName: vimState.editor.document.fileName,
                position: lastJump.position.getLineBegin(),
            });
            vimState.globalState.jumpTracker.recordJump(jump_1.Jump.fromStateNow(vimState), jump);
...
let OrthogonalSplit = class OrthogonalSplit extends BaseCommand {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.ModeName.Normal, mode_1.ModeName.Visual, mode_1.ModeName.VisualLine];
        this.keys = [['<C-w>', 's'], ['<C-w>', '<C-s>']];
    }
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            vimState.postponedCodeViewChanges.push({
...
let ActionDeleteChar = class ActionDeleteChar extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield state.setCurrentMode(mode_1.ModeName.Normal);
            return state;
        });
    }
};
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!deleteStartPosition.isEqual(deleteEndPosition)) {
                if (startPosition.isEqual(position)) {
                    ...
                    vimState.cursorStartPosition = vimState.cursorStopPosition = startPosition.withColumn(trimmedLinesContent.length - columnDeltaOffset);
                    yield vimState.setCurrentMode(mode_1.ModeName.Normal);
                }
            }
            return vimState;
...
let ActionJoinNoWhitespace = class ActionJoinNoWhitespace extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            newState.cursorStopPosition = new position_1.Position(position.line, lineOne.length);
            return newState;
        });
    }
};
...
let ActionReplaceCharacterVisualBlock = class ActionReplaceCharacterVisualBlock extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const topLeft = modes_1.VisualBlockMode.getTopLeftPosition(vimState.cursorStopPosition, vimState.cursorStartPosition);
            vimState.cursors = [new range_1.Range(topLeft, topLeft)];
            yield vimState.setCurrentMode(mode_1.ModeName.Normal);
            return vimState;
        });
    }
...
let ActionXVisualBlock = class ActionXVisualBlock extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            const lines = [];
            for (const { line, start, end } of position_1.Position.IterateLine(vimState)) {
                lines.push(line);
                vimState.recordedState.transformations.push({
                    type: 'deleteRange',
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const { line, start } of position_1.Position.IterateLine(vimState)) {
                ...
                vimState.cursors.push(new range_1.Range(start, start));
            }
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const { end } of position_1.Position.IterateLine(vimState)) {
                vimState.cursors.push(new range_1.Range(end, end));
            }
            vimState.cursors = vimState.cursors.slice(1);
            return vimState;
        });
...
let ActionDeleteLineVisualMode = class ActionDeleteLineVisualMode extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            if (vimState.currentMode === mode_1.ModeName.Visual) {
                return new operator.DeleteOperator(this.multicursorIndex).run(vimState, vimState.cursorStartPosition.getLineBegin(), vimState.cursorStopPosition.getLineEnd());
            }
            else {
                return new operator.DeleteOperator(this.multicursorIndex).run(vimState, position.getLineBegin(), position.getLineEnd());
            }
        });
    }
};
...
let ActionChangeLineVisualMode = class ActionChangeLineVisualMode extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            return new operator.DeleteOperator(this.multicursorIndex).run(vimState, vimState.cursorStartPosition.getLineBegin(), vimState.cursorStopPosition.getLineEndIncludingEOL());
        });
    }
};
...
let ActionChangeChar = class ActionChangeChar extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield state.setCurrentMode(mode_1.ModeName.Insert);
            return state;
        });
    }
...
let ToggleCaseAndMoveForward = class ToggleCaseAndMoveForward extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            yield new operator.ToggleCaseOperator().run(vimState, vimState.cursorStopPosition, vimState.cursorStopPosition);
            ...
            for (let { start, end, word } of position_1.Position.IterateWords(whereToStart)) {
                ...
                do {
                    ...
                    if (num !== null &&
                        ...
                        vimState.cursorStopPosition = yield this.replaceNum(num, this.offset * (vimState.recordedState.count || 1), start, end);
...
let ActionShowFileInfo = class ActionShowFileInfo extends BaseCommand {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.ModeName.Normal];
        this.keys = [['<C-g>']];
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            statusBarTextUtils_1.ReportFileInfo(position, vimState);
            return vimState;
        });
    }
};
