...
async function enableLanguageIdInConfig(target, languageId) {
...
async function disableLanguageIdInConfig(target, languageId) {
    const scope = config.configTargetToScope(target);
...
async function enableLanguageIdForTarget(languageId, enable, target, isCreateAllowed) {
